...
// other bells and whistles, just a fast library that uses minimal memory    //
// and CPU. I created this because I foresee encoders being used widely,     //
// especially by Arduino Due users. Encoders are prevalent in many consumer  //
// electronic devices because they offer excellent interaction control.      //
// Paired with an LCD or OLED, many creative UX experiences can be explored  //
// with relative ease, thanks to the Arduino community.                      //
